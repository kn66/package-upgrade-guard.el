...
Note: Starting with Emacs 31, similar package-upgrade review functionality is available in upstream Emacs. This package is still useful for earlier Emacs versions (for example, Emacs 27.1-30).
